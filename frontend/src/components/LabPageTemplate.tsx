...
export default function LabPageTemplate({ labId, labName }: Props) {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6">Inventaris {labName}</h1>
      <input
        type="text"
      ...
      />
      <h2 className="text-xl font-semibold mb-2">Daftar Item</h2>
      <table className="table-auto w-full border mb-6 text-sm">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="border px-2 py-1">Baik</th>
            ...
            .map((item) => {
              ...
              return (
                <tr key={item.id}>
                  ...
                  <td className="border px-2 py-1 text-center">{baik}</td>
                  <td className="border px-2 py-1 text-center">{rusak}</td>
            ...
            {editUnitSelection.map((editUnit, i) => (
              <div key={i} className="flex items-center mb-2">
                ...
                <span className="text-sm">
                  {editUnit.code || `Unit ${i + 1}`} — kondisi:{" "}
                  {editUnit.condition}
                </span>
              </div>
            ))}
